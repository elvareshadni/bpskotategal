...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-panel sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin'); ?>">
                ...
                <img src="<?= base_url('/img/logobpskotategal.png'); ?>" height="30" alt="BPS Logo">
            </a>
            ...
            <li class="nav-item <?= uri_string() === 'admin/laporan-kunjungan' ? 'active' : '' ?>">
                <a class="nav-link collapsed" href="<?= base_url('admin/laporan-kunjungan'); ?>">
            ...
            <li class="nav-item <?= uri_string() === 'admin/data-indikator' ? 'active' : '' ?>">
                <a class="nav-link collapsed" href="<?= base_url('admin/data-indikator'); ?>">
    ...
    <?php if(session()->getFlashdata('success')): ?>
        <script>
            Swal.fire({icon:'success', title:'Berhasil', text:'<?= esc(session()->getFlashdata('success')) ?>'});
        </script>
    <?php endif; ?>
